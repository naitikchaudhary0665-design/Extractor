    ...
    if st.button("🚀 Process & Generate Full Excel"):
        ...
        for index, file in enumerate(uploaded_files):
            ...
            try:
                ...
                # Available models list for current SDK
                ...
                if not response or not response.text:
                    st.error(f"Failed for {file.name}. Last API Error: {last_error}")
                    continue
        ...
        if all_data:
            ...
            st.warning("No data extracted. Please verify your Google AI Studio API Key and permissions.")
