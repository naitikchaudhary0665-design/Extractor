...
# Safe Tesseract path configuration for both Windows (Laptop) and Cloud (Linux)
tesseract_path = shutil.which("tesseract")
if tesseract_path:
    pytesseract.pytesseract.tesseract_cmd = tesseract_path
else:
    # Agar shutil ko path na mile aur Windows ho toh ye use karega, warna Linux ka default
    if os.name == 'nt':
