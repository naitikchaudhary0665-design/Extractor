    ...
    if st.button("🚀 Process & Generate Full Excel"):
        ...
        for index, file in enumerate(uploaded_files):
            ...
            try:
                ...
                # Model Fallback Mechanism (Ek ke baad ek models try karega taaki error na aaye)
                models_to_try = ["gemini-1.5-flash", "gemini-1.5-pro", "gemini-2.0-flash", "gemini-flash"]
                response = None
                success = False
                ...
                if not success or not response:
                    raise Exception("All model attempts failed for this file. Check API permissions.")
